...
const IPAddress LANip(192, 168, 1, 90);
const IPAddress gateway(192, 168, 1, 1);
const IPAddress subnet(255, 255, 255, 0);
// scroll down to sendMainMute() and define XR18 vs X32 msg

// *** Setup values***//
//String MixerIP = "192.168.3.2";
//const IPAddress outIp(192, 168, 3, 2);  //XR18 ip address
const IPAddress outIp(192, 168, 1, 158);    // IP of Mixer (X32 emulator) 
...
EmbAJAXStatic s8("</td></tr><a href=\"/page3\">Voc3</a><tr><td></b>");
...
//Serial.begin(115200);
 ...
 //Serial.print("MixerIP:  ");
//Serial.println(outIp); 

Ethernet.begin(mac, LANip, gateway, subnet);
